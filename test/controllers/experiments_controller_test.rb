...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { name: @experiment.name, track_id: @experiment.track_id } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { name: @experiment.name, track_id: @experiment.track_id } }

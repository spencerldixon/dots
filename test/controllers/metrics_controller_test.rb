...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { description: @metric.description, name: @metric.name, track_id: @metric.track_id, unit: @metric.unit } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { description: @metric.description, name: @metric.name, track_id: @metric.track_id, unit: @metric.unit } }
